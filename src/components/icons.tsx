/**
 * Librería de iconos de marca (SVG inline, sin dependencias).
 *
 * Reutilizable: copia este archivo a cualquier proyecto. Todos usan
 * `fill="currentColor"`, así que heredan el color del texto del contenedor
 * y se dimensionan con clases de tamaño (p. ej. `className="size-5"`).
 *
 * Trazados oficiales de cada marca (Simple Icons).
 */
